...
def disparity_cnn_mixed_2_model(input_shape):
    ...
    merge = concatenate([left_1_batch, right_1_batch])
    
    right_2 = Conv2D(filters=62, kernel_size=3, padding='same')(merge)
    ...
    merge_1 = Conv2D(filters=62, kernel_size=3, padding='same')(right_3_batch)
...
# build model
model = disparity_cnn_mixed_2_model(test_left.shape)
