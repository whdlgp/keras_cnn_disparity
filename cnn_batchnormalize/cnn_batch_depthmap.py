...
def disparity_cnn_batchnormalize_model(input_shape):
    ...
    plot_model(model, to_file='model_batch.png', show_shapes=True, show_layer_names=True)
...
# build model
model = disparity_cnn_batchnormalize_model(test_left.shape)
